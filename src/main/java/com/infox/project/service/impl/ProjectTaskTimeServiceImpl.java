								...
								if(aa>=0){
									...
									for (EmployeeEntity ec : totalEntitys) {
										if(null == ec.getLbmType()) {
											...
											if(1!=ec.getLbmType() && 3!=ec.getLbmType()&& 4!=ec.getLbmType()) {
												count ++ ;
											}
										}
									}
									
									System.out.println(count*diff+"=="+(((Integer)count).floatValue() * ((Integer)diff).floatValue()));
