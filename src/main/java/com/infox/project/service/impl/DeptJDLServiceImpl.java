...
public class DeptJDLServiceImpl implements DeptJDLServiceI {
			...
			for (EmployeeEntity e : entitys) {
					...
					if(null != pews && pews.size() > 0) {
						for (ProjectEmpWorkingEntity ew : pews) {
							...
							ary2.setTime(DateUtil.formatGG(DateUtil.formatG(lllDate)));
							...
							for (int i = 0; i <= m; i++) {
								...
								if (i == m && !ym1.equals(ym2)) {
									int wd = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), DateUtil.formatG(lllDate));
									zry += NumberUtils.formatNum(uf.getMonth10() + ((Integer) wd).floatValue() / diff);
									//////System.out.println("end======"+DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+"  天数："+wd+"=="+NumberUtils.formatNum(uf.getMonth10()+((Integer)wd).floatValue()/diff));
								}
								// 开始和结束是在同一个月
								if (ym1.equals(ym2)) {
									int wd = DateCal.getWorkingDays(DateUtil.formatG(ew.getStartDate()), DateUtil.formatG(lllDate));
									zry += NumberUtils.formatNum(uf.getMonth10() + ((Integer) wd).floatValue() / diff);
									//////System.out.println(DateUtil.formatG(ew.getStartDate())+"=="+DateUtil.formatG(lllDate)+"  天数："+wd+"=="+NumberUtils.formatNum(uf.getMonth10()+((Integer)wd).floatValue()/diff));
								}
							}
							...
							ary22.setTime(DateUtil.formatGG(DateUtil.formatG(lllDate)));
							...
							int wdcc = DateUtil.compare_date2(DateUtil.formatG(lllDate), DateUtil.formatG(cyear1.getTime())) ;
							if(wdcc == 1) {
								...
								for (int i = 0; i <= m2; i++) {
									...
									if (i == m2 && !ym11.equals(ym22)) {
										...
										if(ew.getStatus() == 4) {
											...
											//判断员工是否有元以下状态
											if(emp.getLbmType() != null) {
												if(emp.getLbmType() == 2 || emp.getLbmType() == 3 || emp.getLbmType() == 4) {
													Calendar t1 = Calendar.getInstance() ;
													t1.setTime(DateUtil.formatGG(emp.getLbmDate())) ;
													
													//如果当前月等于离部门的月份，则按离部门的月份进行计算
													if((fristDay.get(Calendar.MONTH)+1) == (t1.get(Calendar.MONTH)+1)) {
														diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), emp.getLbmDate());
														System.out.println("...已1退出项目.......离部门（转出-非开发部，离职，停薪留职）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime()) +"=....="+DateUtil.formatG(lastDay.getTime())+"=="+emp.getLbmDate());
													} else {
														diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), DateUtil.formatG(lastDay.getTime()));
														System.out.println("...已2退出项目.......离部门（转出-非开发部，离职，停薪留职）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime()) +"=....="+DateUtil.formatG(lastDay.getTime())+"=="+DateUtil.formatG(lastDay.getTime()));
													}
											...
											lastEndDate.add(DateUtil.formatG(lllDate)) ;
											allTotalDays += wd ;
											System.out.println(DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  3稼0动率"+quot);
										...
										if(ew.getStatus() != 4) {
											...
											if(null != emp.getLbmType() && !"".equals(emp.getLbmType())) {
												if(emp.getLbmType() == 1) {
													...
													if((dbc.get(Calendar.YEAR) + "" + (dbc.get(Calendar.MONTH) + 1)).equals((fristDay.get(Calendar.YEAR) + "" + (fristDay.get(Calendar.MONTH) + 1)))) {
														diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), DateUtil.formatG(lllDate));
														System.out.println(".......离部门（转出-开发部，但还在项目中）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate));
													}
												}
												...
												if(emp.getLbmType() == 2 || emp.getLbmType() == 3 || emp.getLbmType() == 4) {
													...
													if((fristDay.get(Calendar.MONTH)+1) == (t1.get(Calendar.MONTH)+1)) {
														diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), emp.getLbmDate());
														System.out.println("...未退出项目.......离部门（转出-非开发部，离职，停薪留职）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime()) +"=....="+DateUtil.formatG(lastDay.getTime())+"=="+emp.getLbmDate());
													} else {
														diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), DateUtil.formatG(lastDay.getTime()));
														System.out.println("...未退出项目.......离部门（转出-非开发部，离职，停薪留职）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime()) +"=....="+DateUtil.formatG(lastDay.getTime())+"=="+DateUtil.formatG(lastDay.getTime()));
													}
													
													
													//如果离部门时间小于项目的结束时间，则按离部门时间计算，并修改项目的结束时间为离部门时间
													int cdd1 = DateUtil.compare_date2(emp.getLbmDate(), DateUtil.formatG(lllDate)) ;
													if(cdd1 == -1) {
											...
											if((fristDay.get(Calendar.YEAR) + "" + (fristDay.get(Calendar.MONTH) + 1)).equals((cd.get(Calendar.YEAR) + "" + (cd.get(Calendar.MONTH) + 1)))) {
												...
												int cdd1 = DateUtil.compare_date2(DateUtil.formatG(new Date()), DateUtil.formatG(lllDate)) ;
												...
												if(cdd1 == -1) {
													...
													quot = NumberUtils.formatNum((((Integer) wd).floatValue() * (null != ew.getProject().getQuot()?ew.getProject().getQuot():0f))/((Integer)diff).floatValue()) ;
													System.out.println(DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  3稼1动率"+quot);
													...
													allTotalDays += wd ;
													quot = NumberUtils.formatNum((((Integer) wd).floatValue() * (null != ew.getProject().getQuot()?ew.getProject().getQuot():0f))/((Integer)diff).floatValue()) ;
													System.out.println(DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  3稼2动率"+quot);
												...
												quot = NumberUtils.formatNum((((Integer) wd).floatValue() * (null != ew.getProject().getQuot()?ew.getProject().getQuot():0f))/((Integer)diff).floatValue()) ;
												allTotalDays += wd ;
												System.out.println(DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  3稼3动率"+quot);
									...
									if (ym11.equals(ym22)) {
										...
										if(null != emp.getLbmType() && !"".equals(emp.getLbmType())) {
											if(emp.getLbmType() == 1) {
												...
												if((dbc.get(Calendar.YEAR) + "" + (dbc.get(Calendar.MONTH) + 1)).equals((fristDay.get(Calendar.YEAR) + "" + (fristDay.get(Calendar.MONTH) + 1)))) {
													diff = DateCal.getWorkingDays(DateUtil.formatG(fristDay.getTime()), DateUtil.formatG(lllDate));
													System.out.println("离部门（转出-开发部）-标准天数：" + diff +"=="+DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate));
												}
											}
											if(emp.getLbmType() == 2 || emp.getLbmType() == 3 || emp.getLbmType() == 4) {
												Calendar dbc = Calendar.getInstance() ;
										...
										if(cdd1 == -1) {
											...
											allTotalDays += wd ;
											System.out.println(DateUtil.formatG(ew.getStartDate())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  4稼1动率"+quot);
									...
									if (!ym11.equals(ym22) && (fristDay.get(Calendar.YEAR) + "" + (fristDay.get(Calendar.MONTH) + 1)).equals((cd.get(Calendar.YEAR) + "" + (cd.get(Calendar.MONTH) + 1)))) {
										...
										if (ew.getStatus() == 4) {
											...
											if(cdd1 == -1) {
												...
												quot = NumberUtils.formatNum((((Integer) wd).floatValue() * (null != ew.getProject().getQuot()?ew.getProject().getQuot():0f))/((Integer)diff).floatValue()) ;
												System.out.println(DateUtil.formatG(fristDay.getTime())+"=="+DateUtil.formatG(lllDate)+ew.getEmp().getTruename() +"  项目："+ ew.getProject().getName() + "  当月有效天数"+diff  + "  实际工作天数"+wd  + "  系数"+(null != ew.getProject().getQuot()?ew.getProject().getQuot():0f) +"  5稼动率"+quot);
	...
	public void bzts(EmployeeEntity emp, ProjectTaskTimeForm uf, Map<String,Object> map) {
		for(int month=1; month<=12; month++) {
					...
					if(null != emp.getLbmType() && !"".equals(emp.getLbmType())) {
						...
						if(emp.getLbmType() == 2 || emp.getLbmType() == 3 || emp.getLbmType() == 4) {
							...
							if(now.get(Calendar.MONTH) == lbmDate.get(Calendar.MONTH)) {
								...
								wd = DateCal.getWorkingDays(DateUtil.formatG(start.getTime()), DateUtil.formatG(end.getTime()));  
							...
							if((month-1) < lbmDate.get(Calendar.MONTH)) {
								...
								wd = DateCal.getWorkingDays(DateUtil.formatG(start.getTime()), DateUtil.formatG(end.getTime()));  
								System.out.println(emp.getTruename() + "\t到2部门类型：" +emp.getDbmType()+"\t"+DateUtil.formatG(start.getTime())+"=="+DateUtil.formatG(end.getTime()) + "  实际工作天数：" + wd);
							}
						}
						...
						if(emp.getLbmType() == 1) {
							...
							wd = DateCal.getWorkingDays(DateUtil.formatG(start.getTime()), DateUtil.formatG(end.getTime()));  
							System.out.println(emp.getTruename() + "\t到部3门类型：" +emp.getDbmType()+"\t"+DateUtil.formatG(start.getTime())+"=="+DateUtil.formatG(end.getTime()) + "  实际工作天数：" + wd);
						}
						...
						wd = DateCal.getWorkingDays(DateUtil.formatG(start.getTime()), DateUtil.formatG(end.getTime()));  
						System.out.println(emp.getTruename() + "\t到部4门类型：" +emp.getDbmType()+"\t"+DateUtil.formatG(start.getTime())+"=="+DateUtil.formatG(end.getTime()) + "  实际工作天数：" + wd);
					}
				}
			...
			switch (month) {
			case 1: uf.setBzts1(wd); 
					if(null != map.get("bzts1")) map.put("bzts1", (((Integer)map.get("bzts1"))+wd)) ;
					else map.put("bzts1", wd) ;
				break;
			case 2: uf.setBzts2(wd); 
					if(null != map.get("bzts2")) map.put("bzts2", (((Integer)map.get("bzts2"))+wd)) ;
					else map.put("bzts2", wd) ;
				break;
			case 3: uf.setBzts3(wd);  
					if(null != map.get("bzts3")) map.put("bzts3", (((Integer)map.get("bzts3"))+wd)) ;
					else map.put("bzts3", wd) ;
				break;
			case 4: uf.setBzts4(wd);  
					if(null != map.get("bzts4")) map.put("bzts4", (((Integer)map.get("bzts4"))+wd)) ;
					else map.put("bzts4", wd) ;
				break;
			case 5: uf.setBzts5(wd);  
					if(null != map.get("bzts5")) map.put("bzts5", (((Integer)map.get("bzts5"))+wd)) ;
					else map.put("bzts5", wd) ;
				break;
			case 6: uf.setBzts6(wd);  
					if(null != map.get("bzts6")) map.put("bzts6", (((Integer)map.get("bzts6"))+wd)) ;
					else map.put("bzts6", wd) ;
				break;
			case 7: uf.setBzts7(wd);  
					if(null != map.get("bzts7")) map.put("bzts7", (((Integer)map.get("bzts7"))+wd)) ;
					else map.put("bzts7", wd) ;
				break;
			case 8: uf.setBzts8(wd);  
					if(null != map.get("bzts8")) map.put("bzts8", (((Integer)map.get("bzts8"))+wd)) ;
					else map.put("bzts8", wd) ;
				break;
			case 9: uf.setBzts9(wd);  
					if(null != map.get("bzts9")) map.put("bzts9", (((Integer)map.get("bzts9"))+wd)) ;
					else map.put("bzts9", wd) ;
				break;
			case 10: uf.setBzts10(wd);  
					if(null != map.get("bzts10")) map.put("bzts10", (((Integer)map.get("bzts10"))+wd)) ;
					else map.put("bzts10", wd) ;
				break;
			case 11: uf.setBzts11(wd);  
					if(null != map.get("bzts11")) map.put("bzts11", (((Integer)map.get("bzts11"))+wd)) ;
					else map.put("bzts11", wd) ;
				break;
			case 12: uf.setBzts12(wd);  
					if(null != map.get("bzts12")) map.put("bzts12", (((Integer)map.get("bzts12"))+wd)) ;
					else map.put("bzts12", wd) ;
				break;
			default:
				break;
			}
