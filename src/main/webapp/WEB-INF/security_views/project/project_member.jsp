	...
	$(function() {
		...
		dataGrid2 = $("#d2").datagrid({
			...
			frozenColumns: [[
			    { field: 'ck', checkbox: true },
			    { field: 'id', title: '工号', width: 60, sortable: true },
			    { field: 'emp_name', title: '姓名', width: 60, sortable: true }
			]],
			columns: [[
			    { field: 'startDate', title: '起始日期', width:120, sortable: true, formatter:function(value,row){
			    	if(undefined == value || "" == value) { return "未设置"; } else { return value; }
			    }},
			    { field: 'endDate', title: '结束日期', width:120, sortable: true, formatter:function(value,row){
			    	if(undefined == value || "" == value) { return "未设置"; } else { return value; }
			    }},
			]]
	    });
