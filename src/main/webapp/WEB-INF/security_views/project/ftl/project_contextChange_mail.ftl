    	...
    	<div class="content">
    		<table>
    			...
    			<tr>
    				...
    				<td width="320">${project.quot?default('')}</td>
    			</tr>
    			<tr>
    				<th>起始日期：</th>
    							...
    							<td class="devlist">
    								<ul>
    									<#list currentMembers as c>
    										<li><div class="lname">${c.truename?default('')}</div><div class="ltime">${c.startDate?string("yyyy-MM-dd")} - ${c.endDate?string("yyyy-MM-dd")}</div></li>
			    							<#if !c_has_next >
